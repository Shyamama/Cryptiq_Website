      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="font-mono text-[11px] tracking-widest text-brand text-center max-w-lg font-medium">
              NIST FIPS 203 · FIPS 204 · FIPS 205 COMPLIANT
            </p>
          </div>
          <p className="font-mono text-[10px] tracking-wider text-brand/70 mt-2">
